...
class LocalFileUserDataProviderSpec extends Specification {
  ...
  void "return defaultLegacyUdf if front50.getApplication throws SpinnakerHttpException with NOT_FOUND status"() {
    given:
    RetrofitError nonFoundRetrofitError = RetrofitError.httpError("url",
    ...
    localFileUserDataProvider.front50Service.getApplication(_) >> {throw new SpinnakerHttpException(nonFoundRetrofitError)}
